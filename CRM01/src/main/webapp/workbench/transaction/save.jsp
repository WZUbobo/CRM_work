...
<body>
	...
	<form action="workbench/transaction/save.do" id="tranForm" method="post"class="form-horizontal" role="form" style="position: relative; top: -30px;">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control" id="create-activitySrc" value="下海1">
				<input type="hidden" name="activityId" value="6816866092ef40a9bd2c3cf5bf2af2c8"/>
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control" id="create-contactsName" value="马化腾">
				<input type="hidden" name="contactsId" value="b18117b0593b49299c09d9a4b7ce293c"/>
