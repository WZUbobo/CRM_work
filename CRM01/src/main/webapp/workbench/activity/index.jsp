...
<script type="text/javascript">
	...
	$(function(){
		...
		/*
		操作模态窗口的方式：
						需要操作模态窗口的jquery对象，调用model方法，为该方法传递参数  show:打开模态窗口 hide:关闭模态窗口

		*/
			//$("#createActivityModal").modal("show");
			//走后台，目的是为取得用户信息列表，为所有者下拉框铺直
			$.ajax({
		...
		$("#activityBody").on("click",$("input[name=xz]"),function () {
			//$("#qx").prop("check",$("input[name=xz]").length==$("input[name=xz]:checked".length);
